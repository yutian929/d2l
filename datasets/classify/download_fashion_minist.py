...
def show_batch_images(images, labels, classes):
    """
    ...
    img_height = grid_height // (batch_size // img_per_row)
...
if __name__ == '__main__':
    ...
    train_loader, test_loader = get_fashion_mnist_loaders(data_dir, batch_size, num_workers)
    ...
    # 显示批次图像
    show_batch_images(images, labels, classes)

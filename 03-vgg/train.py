...
def main():
    ...
    train_loader, test_loader = get_fashion_mnist_loaders(data_dir, batch_size=64, num_workers=2, resize_size=(64, 64))
    
    # 创建模型
    model = VGG().to(device)
    print(model)
    # model = VGGMinimal().to(device)
